                ...
                <FlexColumn
                    ...
                    <Box sx={{ position: 'relative' }} >
                        ...
                        <Typography variant='banner' component={'h1'} textAlign={'center'}  >
                            ...
                            م/   <span style={{ color: 'orange', }}>محمد</span>  
                        </Typography>
                    ...
                    <Box display={'flex'} justifyContent={'space-around'} flexDirection={'row'} sx={{ minWidth: '250px' }}>
                        <IconButton component={Link} to={'https://www.facebook.com/ .Geo?mibextid'}>
                            <FaFacebook style={{
                                color: theme.palette.neutral[0],
                            }} />
                        </IconButton>

                        <IconButton component={Link} to={"https://api.whatsapp.com/send?phone=2001001902943"}>
                            <FaWhatsapp style={{
                                color: theme.palette.neutral[0],
                            }} />
                        </IconButton>
                        ...
                        <IconButton component={Link} to={'https://t.me/mrmo '}>
