    ...
    return (
        <Section sx={{ minHeight: '60vh', bgcolor: "rgb(18, 20, 27)" }}>
            <FlexColumn gap={'12px'}>
                ...
                <Image img={'/assets/Menassty-nobg.png'} maxWidth='160px' ratio={'auto'} />
                ...
                <FlexRow justifyContent={'center'} >
                    <IconButton component={Link} >
                        {/* to={'https://www.facebook.com/المستر.Geo?mibextid'} */}
                        <Image img={'/assets/facebook.webp'} maxWidth='50px' ratio={'auto'} />
                    </IconButton>
                    <IconButton component={Link} >
                        {/* to={'https://youtube.com/@mohammedelbltagy?si=iGiK5HHUyvo8Uyye'} */}
                        <Image img={'/assets/youtube.png'} maxWidth='50px' ratio={'auto'} />
                    </IconButton>
                    <IconButton component={Link}>
                        {/*  to={"https://api.whatsapp.com/send?phone=2001553251467&text=" + whatsText} */}
                        <Image img={'/assets/whatsapp.png'} maxWidth='50px' ratio={'auto'} />
                    </IconButton>
                    <IconButton component={Link} >
                        {/* to={'https://t.me/mrmoالمستر'} */}
                ...
                <Typography component={Link} to={"https://api.whatsapp.com/send?phone=2001001902943&text=" + 'from المستر Platform'} variant='body2' sx={{ color: "grey.0", textDecoration: 'none' }} noWrap>
