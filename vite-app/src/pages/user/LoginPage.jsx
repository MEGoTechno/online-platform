...
function LoginPage() {
    ...
    return (
        <Section sx={{ minHeight: '86vh' }}>
            ...
            <SEOHelmetAsync
                title={'تسجيل الدخول - تسجيل الدخول لمنصه المستر'}
                desc={"سجل دخولك الان, وابدا رحلتك فى منصه المستر"}
                url={"https:// .com/login"}
                isSiteLink={true}
            />
            ...
            {/* <ModalStyled
                ...
                action={() => {
                    window.location.href = "https://api.whatsapp.com/send?phone=" + '2001001902943' + "&text=" + 'لقد نسيت كلمه السر';
                }}
            /> */}
