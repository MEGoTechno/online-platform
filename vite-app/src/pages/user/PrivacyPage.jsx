...
function PrivacyPage() {
    ...
    return (
        <Section>
            ...
            <SEOHelmetAsync
                title={'Privacy - السياسات الخاصه بمنصه المستر'}
                desc={"كل التفاصيل الخاصه بمنصه المستر , بطل تضيع وقت وابدا يلا "}
                url={"https:// .com/privacy"}
                isSiteLink={true}
            />

            {/* <Helmet>
                <title>Privacy - السياسات الخاصه بمنصه المستر</title>
                <meta name="description" content="كل التفاصيل الخاصه بمنصه المستر , بطل تضيع وقت وابدا يلا " />
                <meta property="og:title" content=" السياسات الخاصه بمنصه المستر" />
                <meta property="og:description" content="كل التفاصيل الخاصه بمنصه المستر , بطل تضيع وقت وابدا يلا " />
                <meta property="og:url" content="https:// .com/privacy" />
